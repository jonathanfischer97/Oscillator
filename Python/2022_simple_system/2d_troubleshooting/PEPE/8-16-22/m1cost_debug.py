...
class Oscillator: 
	...
	def __init__(self, parameter_values, params, initial_conditions, dt = 0.1, mode = 1, sigma = 0.001): 
...
viablePoints = pickle.load(open('/Users/jonathanfischer/Desktop/Desktop - Jonathan’s MacBook Air/Oscillator/Python/2022_simple_system/2d_troubleshooting/PEPE/8-3-22/8-5_Region0ViableSet_Iter10.p','rb'))
# %%
x = viablePoints[200]
x
